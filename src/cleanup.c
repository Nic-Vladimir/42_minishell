...
/*   Updated: 2025/08/04 09:25:14 by mgavornik        ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void	force_cleanup_all_memory(t_env **env)
{
	...
	// Report what we're about to clean
	report_memory_usage(*env);
	
	// Use comprehensive cleanup
	comprehensive_cleanup(env);
	
	// Additional cleanup for any global variables or static allocations
...
/**
 * Simple wrapper function - call this to free everything in your minishell
 * Usage: free_everything(&env);
 */
